...
def _infer_net_class(net_name: str) -> str:
...
# ---------------------------------------------------------------------------
# Electrical-type inference for a pin based on net class + component type
# ---------------------------------------------------------------------------

def _infer_electrical_type(net_class: str, component_type: str) -> str:
    if net_class == "ground":
        return "ground"
    if net_class == "power":
